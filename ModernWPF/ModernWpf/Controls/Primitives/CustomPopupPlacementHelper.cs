...
namespace ModernWpf.Controls.Primitives
{
    ...
    internal static class CustomPopupPlacementHelper
    {
            ...
            FrameworkElement child = null)
        {
            ...
            var preferredPlacement = CalculatePopupPlacement(placement, popupSize, targetSize, offset, child, transformToDevice);
            ...
            Matrix transformToDevice = default)
        {
            ...
            if (child != null)
            {
                var childOffset = VisualTreeHelper.GetOffset(child);
