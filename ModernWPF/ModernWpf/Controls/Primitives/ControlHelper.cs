...
namespace ModernWpf.Controls.Primitives
{
    public static class ControlHelper
    {
        ...
        ///// <summary>
        ///// Identifies the Header Font Weight dependency property.
        ///// </summary>
        ...
        //        typeof(FontWeight),
        //        typeof(ControlHelper),
        //        new FrameworkPropertyMetadata(OnHeaderFontWeightChanged));

        ///// <summary>
        ///// Gets the font weight for the control's header.
        ///// </summary>
        ///// <param name="control">The element from which to read the property value.</param>
        ///// <returns>The content of the control's header. The default is **null**.</returns>
        //public static FontWeight GetHeaderFontWeightChanged(Control control)
        //{
        //    return (FontWeight)control.GetValue(HeaderFontWeightProperty);
        //}

        ///// <summary>
        ///// Sets the font weight for the control's header.
        ///// </summary>
        ///// <param name="control">The element on which to set the attached property.</param>
        ///// <param name="value">The property value to set.</param>
        //public static void SetHeaderFontWeight(Control control, FontWeight value)
        //{
        //    control.SetValue(HeaderFontWeightProperty, value);
        //}
        ...
        //        typeof(double),
        //        typeof(ControlHelper),
        //        new FrameworkPropertyMetadata(OnHeaderFontSizeChanged));
        ...
        ///// <param name="control">The element from which to read the property value.</param>
        ///// <returns>The content of the control's header. The default is **null**.</returns>
        //public static double GetHeaderFontSizeChanged(Control control)
        //{
        //    return (double)control.GetValue(HeaderFontSizeProperty);
        //}
        ...
        ///// <param name="control">The element on which to set the attached property.</param>
        ///// <param name="value">The property value to set.</param>
        //public static void SetHeaderFontSize(Control control, double value)
        //{
        //    control.SetValue(HeaderFontSizeProperty, value);
        //  //  ControlHelper()    control.FontSize = value;
        //}
